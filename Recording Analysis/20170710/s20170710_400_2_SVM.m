model_file = 'E:\MEA Data\20170710_400_2\mdl-f0015-e57.mat';
...
e = 1;
file_labels = {'Baseline', '2.5 V', 'No Stim', '0.9 V', 'No Stim', '0.3 V', 'No Stim'};
electrodes = [57];
...
legend ([s1, l1, l2]);
title("Frequency and Duration Analysis - HC");
hold off
...
legend([l3, l4]);
title("Power and Intensity Analysis - HC");
hold off